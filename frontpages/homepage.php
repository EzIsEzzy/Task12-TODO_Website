    ...
    <main id="main">
        ...
        <section class="hero">
            <div class="hero_text">
                ...
                <div>
                    <br>
                    <a href="./notepage.php">Add your Note!</a>
                </div>
            </div>
            <div class="notes">
            <table>
                ...
                <tbody>
                    ...
                    if (count($notes->All_singleUser('user_id', $user['id'])) > 0) {
                        ...
                        if($row['done'] == (bool)0)
                            $text .= 'Not Done!';
                        $text .= "</td><td><a href='../frontpages/noteupdate.php?id=".$row['id']."'>Update</a></td><td><a href='../backpages/notedelete_back.php?id=".$row['id']."'>Delete</a></td></tr>";
                        echo $text;
                        }
                    }
                    else{
