...
<main id="register">
    ...
    <section>
        <a href="../frontpages/homepage.php"><img src="../assets/images/back-button.png" alt="back_button" width="50px" height="50px"></a>
        <?php echo '<img src="'. $user['picture'] .'" id="profile" alt="">'?>;
        <h1>Update Profile</h1>
        <br>
            <form action="../backpages/updateprofile_back.php?id=<?php echo $user['id'] ?>" method="post" enctype="multipart/form-data">
