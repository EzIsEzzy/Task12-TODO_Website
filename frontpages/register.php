...
<main id="register">
    ...
    <section>
        <a href="../index.php"><img src="../assets/images/back-button.png" alt="back_button" width="50px" height="50px"></a>
        <h1>TODO App</h1>
        <br>
            <form action="../backpages/register_back.php" method="post" enctype="multipart/form-data">
                <h2>Register Info</h2>
                <br>
